...
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('customer.menu') }}" class="text-gray-700 hover:text-orange-600 px-3 py-2 rounded-md text-sm font-medium">
    ...
    <div class="bg-orange-600 text-white py-12">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <a href="{{ route('customer.menu') }}" class="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition duration-200">
    ...
    <div class="max-w-7xl mx-auto py-8 px-4">
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-md transition duration-200">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center mt-3">
                            ...
                            <a href="{{ route('customer.menu.item', $item) }}" class="bg-orange-500 text-white px-3 py-1 rounded-md text-sm hover:bg-orange-600 transition duration-200">
                                View Details
                            </a>
                        </div>
                    </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <a href="{{ route('customer.menu') }}" class="bg-white rounded-lg shadow p-6 text-center hover:shadow-md transition duration-200">
            ...
            <a href="{{ route('customer.orders.index') }}" class="bg-white rounded-lg shadow p-6 text-center hover:shadow-md transition duration-200">
            ...
            <a href="{{ route('customer.profile.show') }}" class="bg-white rounded-lg shadow p-6 text-center hover:shadow-md transition duration-200">
            ...
            <div class="space-y-4">
                ...
                <div class="border border-gray-200 rounded-lg p-4">
                    ...
                    <div class="mt-2 flex space-x-2">
                        ...
                        <a href="{{ route('customer.reviews.create', $order) }}" class="text-blue-600 hover:text-blue-800 text-sm">
                            Write Review
                        </a>
                        @endif
                    </div>
