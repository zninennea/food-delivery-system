        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('customer.cart.index') }}" class="text-orange-600 px-3 py-2 rounded-md text-sm font-medium">
    ...
    <div class="max-w-4xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="bg-white shadow rounded-lg">
            ...
            <div class="p-6">
                    ...
                    <div class="flex items-center justify-between border-b border-gray-200 pb-4">
                        <div class="flex items-center">
                            @if($item->menuItem->image)
                                <img src="{{ asset('storage/' . $item->menuItem->image) }}" alt="{{ $item->menuItem->name }}" class="h-16 w-16 object-cover rounded-md">
                            @else
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex items-center space-x-2">
                                <button class="decrease-quantity px-2 py-1 border border-gray-300 rounded" data-cart-id="{{ $item->id }}">-</button>
                                <span class="quantity-display w-8 text-center">{{ $item->quantity }}</span>
                                <button class="increase-quantity px-2 py-1 border border-gray-300 rounded" data-cart-id="{{ $item->id }}">+</button>
                            </div>
                ...
                <div class="mt-6 border-t border-gray-200 pt-6">
                    ...
                    <div class="mt-6 flex justify-between">
                        ...
                        <button id="checkout-btn" class="bg-orange-500 text-white px-6 py-2 rounded-md hover:bg-orange-600">
                            Proceed to Checkout
                        </button>
                    </div>
                </div>
            ...
            <div class="p-6 text-center">
                ...
                <a href="{{ route('customer.dashboard') }}" class="bg-orange-500 text-white px-4 py-2 rounded-md hover:bg-orange-600">
                    Browse Menu
                </a>
            </div>
            @endif
        ...
        <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <form id="checkout-form" action="{{ route('customer.orders.store') }}" method="POST">
                ...
                <div class="mt-6 flex justify-end space-x-3">
                    <button type="button" id="cancel-checkout" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">
                        Cancel
                    </button>
