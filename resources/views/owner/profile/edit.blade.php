                ...
                profilePictureInput.addEventListener('change', function (e) {
                    ...
                    if (file) {
                        ...
                        reader.onload = function (e) {
                            ...
                            preview.innerHTML = `
                                <p class="text-sm font-medium text-stone-700 mb-2">New Preview:</p>
                                <div class="relative inline-block">
            ...
            if (backgroundImageInput) {
                backgroundImageInput.addEventListener('change', function (e) {
                    ...
                    if (file) {
                        ...
                        reader.onload = function (e) {
                            // Remove old preview if exists
                            const oldPreview = document.getElementById('background-preview');
                            if (oldPreview) oldPreview.remove();

                            // Create new preview
                            const preview = document.createElement('div');
                            preview.id = 'background-preview';
                            preview.className = 'mb-4 p-4 bg-stone-50 rounded-xl border border-stone-200';
                            preview.innerHTML = `
                                <p class="text-sm font-medium text-stone-700 mb-2">New Background Preview:</p>
                                <div class="relative">
                                    <img src="${e.target.result}" 
                            ...
                            `;
                            backgroundImageInput.parentNode.insertBefore(preview, backgroundImageInput.nextSibling);
                        }
                        reader.readAsDataURL(file);
                    }
                });
